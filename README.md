...
Este programa busca simular las funciones básicas de una calculadora digital a la vez que funciona como ejercicio integrador de conocimientos para los miembros del equipo de desarrollo.
...
```bash
git clone https://github.com/dantesanchez-ai/Calculadora-digital-DiazA-SanchezT-MaciasC.git
cd [Calculadora-digital-DiazA-SanchezT-MaciasC]
```
